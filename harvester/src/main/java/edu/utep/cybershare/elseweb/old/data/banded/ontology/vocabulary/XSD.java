...
public class XSD extends Vocabulary {
	...
	public static final String Datatype_date = NAMESPACE + "#date";
	...
	public OWLDatatype getDataType_date(){
		return bundle.getDataFactory().getOWLDatatype(IRI.create(Datatype_date));
	}	
