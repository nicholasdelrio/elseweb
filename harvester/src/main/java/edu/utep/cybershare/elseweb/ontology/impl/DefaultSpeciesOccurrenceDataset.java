 ...
 * Source Class: DefaultSpeciesOccurrenceDataset <br>
 * @version generated on Thu Feb 13 13:45:51 GMT-07:00 2014 by nick
 */
public class DefaultSpeciesOccurrenceDataset extends WrappedIndividualImpl implements SpeciesOccurrenceDataset {

    public DefaultSpeciesOccurrenceDataset(OWLOntology ontology, IRI iri) {
        super(ontology, iri);
    }
    ...
    public Collection<? extends Layer> getHasLayer() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_HASLAYER,
                                               DefaultLayer.class);
    }

    public boolean hasHasLayer() {
	   return !getHasLayer().isEmpty();
    }

    public void addHasLayer(Layer newHasLayer) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_HASLAYER,
                                       newHasLayer);
    }

    public void removeHasLayer(Layer oldHasLayer) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_HASLAYER,
                                          oldHasLayer);
    }
