package edu.utep.cybershare.elseweb.build.edac.services.source.edac;
...
import edu.utep.cybershare.elseweb.build.edac.services.source.edac.fgdc.FGDCDocument;
import edu.utep.cybershare.elseweb.build.edac.services.source.edac.fgdc.theme.Themes;
...
public class WCSDigest {
	...
	private void setUUID(){
		try{this.uuid =  jsonDigest.getString("uuid");}
		catch(Exception e){e.printStackTrace();}		
	}
