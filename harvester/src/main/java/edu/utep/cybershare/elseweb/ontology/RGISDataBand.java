 ...
 * Source Class: RGISDataBand <br>
 * @version generated on Thu Feb 13 13:45:51 GMT-07:00 2014 by nick
 */

public interface RGISDataBand extends DataBand {
    ...
    /* ***************************************************
     * Property http://ontology.cybershare.utep.edu/ELSEWeb/elseweb-edac.owl#wasMeasuredBy
     */
     
    /**
     * Gets all property values for the wasMeasuredBy property.<p>
     * 
     * @returns a collection of values for the wasMeasuredBy property.
     */
    Collection<? extends MODISMeasurement> getWasMeasuredBy();

    /**
     * Checks if the class has a wasMeasuredBy property value.<p>
     * 
     * @return true if there is a wasMeasuredBy property value.
     */
    boolean hasWasMeasuredBy();

    /**
     * Adds a wasMeasuredBy property value.<p>
     * 
     * @param newWasMeasuredBy the wasMeasuredBy property value to be added
     */
    void addWasMeasuredBy(MODISMeasurement newWasMeasuredBy);

    /**
     * Removes a wasMeasuredBy property value.<p>
     * 
     * @param oldWasMeasuredBy the wasMeasuredBy property value to be removed.
     */
    void removeWasMeasuredBy(MODISMeasurement oldWasMeasuredBy);


    /* ***************************************************
     * Property http://ontology.cybershare.utep.edu/ELSEWeb/elseweb-edac.owl#wasModelledBy
     */
     
    /**
     * Gets all property values for the wasModelledBy property.<p>
     * 
     * @returns a collection of values for the wasModelledBy property.
     */
    Collection<? extends PRISMModelling> getWasModelledBy();

    /**
     * Checks if the class has a wasModelledBy property value.<p>
     * 
     * @return true if there is a wasModelledBy property value.
     */
    boolean hasWasModelledBy();

    /**
     * Adds a wasModelledBy property value.<p>
     * 
     * @param newWasModelledBy the wasModelledBy property value to be added
     */
    void addWasModelledBy(PRISMModelling newWasModelledBy);

    /**
     * Removes a wasModelledBy property value.<p>
     * 
     * @param oldWasModelledBy the wasModelledBy property value to be removed.
     */
    void removeWasModelledBy(PRISMModelling oldWasModelledBy);
