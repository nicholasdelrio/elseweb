 ...
 * Source Class: SpeciesOccurrenceDataset <br>
 * @version generated on Thu Feb 13 13:45:51 GMT-07:00 2014 by nick
 */

public interface SpeciesOccurrenceDataset extends VectorDataset {
    ...
    /* ***************************************************
     * Property http://ontology.cybershare.utep.edu/ELSEWeb/elseweb-data.owl#hasLayer
     */
     
    /**
     * Gets all property values for the hasLayer property.<p>
     * 
     * @returns a collection of values for the hasLayer property.
     */
    Collection<? extends Layer> getHasLayer();

    /**
     * Checks if the class has a hasLayer property value.<p>
     * 
     * @return true if there is a hasLayer property value.
     */
    boolean hasHasLayer();

    /**
     * Adds a hasLayer property value.<p>
     * 
     * @param newHasLayer the hasLayer property value to be added
     */
    void addHasLayer(Layer newHasLayer);

    /**
     * Removes a hasLayer property value.<p>
     * 
     * @param oldHasLayer the hasLayer property value to be removed.
     */
    void removeHasLayer(Layer oldHasLayer);
