 ...
 * Source Class: ExtractAndReproject <br>
 * @version generated on Thu Feb 13 13:45:51 GMT-07:00 2014 by nick
 */

public interface ExtractAndReproject extends DatasetProcessing {
    ...
    /* ***************************************************
     * Property http://ontology.cybershare.utep.edu/ELSEWeb/elseweb-edac.owl#hadInputBandID
     */
     
    /**
     * Gets all property values for the hadInputBandID property.<p>
     * 
     * @returns a collection of values for the hadInputBandID property.
     */
    Collection<? extends BandIdentification> getHadInputBandID();

    /**
     * Checks if the class has a hadInputBandID property value.<p>
     * 
     * @return true if there is a hadInputBandID property value.
     */
    boolean hasHadInputBandID();

    /**
     * Adds a hadInputBandID property value.<p>
     * 
     * @param newHadInputBandID the hadInputBandID property value to be added
     */
    void addHadInputBandID(BandIdentification newHadInputBandID);

    /**
     * Removes a hadInputBandID property value.<p>
     * 
     * @param oldHadInputBandID the hadInputBandID property value to be removed.
     */
    void removeHadInputBandID(BandIdentification oldHadInputBandID);
