 ...
 * Source Class: PublishedMODISDataset <br>
 * @version generated on Thu Feb 13 13:45:51 GMT-07:00 2014 by nick
 */

public interface PublishedMODISDataset extends RGISWCSDataset {
    ...
    /* ***************************************************
     * Property http://ontology.cybershare.utep.edu/ELSEWeb/elseweb-edac.owl#wasPublishedBy
     */
     
    /**
     * Gets all property values for the wasPublishedBy property.<p>
     * 
     * @returns a collection of values for the wasPublishedBy property.
     */
    Collection<? extends Publish> getWasPublishedBy();

    /**
     * Checks if the class has a wasPublishedBy property value.<p>
     * 
     * @return true if there is a wasPublishedBy property value.
     */
    boolean hasWasPublishedBy();

    /**
     * Adds a wasPublishedBy property value.<p>
     * 
     * @param newWasPublishedBy the wasPublishedBy property value to be added
     */
    void addWasPublishedBy(Publish newWasPublishedBy);

    /**
     * Removes a wasPublishedBy property value.<p>
     * 
     * @param oldWasPublishedBy the wasPublishedBy property value to be removed.
     */
    void removeWasPublishedBy(Publish oldWasPublishedBy);
