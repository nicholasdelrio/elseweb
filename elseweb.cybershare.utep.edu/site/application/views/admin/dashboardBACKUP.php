...
class Dashboard extends CI_Controller
 {
    ...
    {
        $this->load->view('adminpages/create');
    }

    public function view()
    {
        $this->load->view('adminpages/view');
    }
...
<html lang="en">
  <head>
    ...
    <title>MetaShare - Dashboard</title>
  ...
  <section id="container" >
                      ...
                      <section class="panel">
                          <div class="panel-body">
                              <a href="#" class="task-thumb">
                                  <img src="<?php echo base_url(ADMIN."img/avatar1.jpg");?>" alt="">
                                          ...
                                          <div class="timeline-desk">
                                              <div class="panel">
                                                  <div class="panel-body">
                                                      ...
                                                      <div class="album">
                                                          <a href="#">
                                                              <img alt="" src="<?php echo base_url(ADMIN."img/sm-img-1.jpg");?>">
                                                          </a>
                                                          <a href="#">
                                                              <img alt="" src="<?php echo base_url(ADMIN."img/sm-img-2.jpg");?>">
                                                          </a>
                                                          <a href="#">
                                                              <img alt="" src="<?php echo base_url(ADMIN."img/sm-img-3.jpg");?>">
                                                          </a>
                                                          <a href="#">
                                                              <img alt="" src="<?php echo base_url(ADMIN."img/sm-img-1.jpg");?>">
                                                          </a>
                          ...
                          <aside class="post-highlight yellow v-align">
                              <div class="panel-body text-center">
                                  <div class="pro-thumb">
                                      ...
                                      <img src="<?php echo base_url(ADMIN."img/ring.jpg");?>" alt="">
                                  </div>
                              </div>
                          </aside>
                      </section>
                                  ...
                                  <div class="follower">
                                      <div class="panel-body">
                                          ...
                                          <div class="follow-ava">
                                              <img src="<?php echo base_url(ADMIN."img/follower-avatar.jpg");?>">" alt="">
                                          </div>
                                      </div>
                                  </div>
      ...
      <footer class="site-footer">
          <div class="text-center">
              2013 &copy; MetaShare by Cyber-ShARE | University of Texas at El Paso.
              <a href="#" class="go-top">
